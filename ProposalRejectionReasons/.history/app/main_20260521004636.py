...
"""
    ...
    proposal_text = """
Hello! I would love to build your small business website. 
I will ensure the site is fully responsive and loads cleanly on both mobile and desktop screens. 
I'll create the mandatory 'About Us' page exactly as requested. 
For SEO, I will conduct thorough keyword research, write meta titles/descriptions, add alt tags, and submit your XML sitemap and robots.txt directly to Google Search Console. 
I will also perform basic performance tuning to meet core-web-vital standards and achieve a green score on Google PageSpeed Insights. 
Upon completion, I will handover all credentials, theme files, and provide a brief how-to guide for your future edits. 
I am ready to take this from zero to live.
"""
