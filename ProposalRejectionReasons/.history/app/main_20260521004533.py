...
if __name__ == "__main__":
    ...
    print("- Loading data...")
    job_description = """I'm ready to launch a small business website whose sole purpose is to give visitors clear, trustworthy information about our company. I already know an “About Us” page is essential, and Iطm happy to hear your recommendations on whether a Home, Contact, or any other page would improve navigation and credibility.
