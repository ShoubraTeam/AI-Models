...
from src.models.training import conv3x3
...
class FaceRecognizerArcFace(nn.Module):
    def __init__(self, num_classes, embedding_dim = 512, margin = 0.5, backbone_weights = False, backbone_weights_link = None):
        # cfg
        super().__init__()
        self.num_classes = num_classes
        self.embedding_dim = embedding_dim
        ...
        if backbone_weights:
            self.backbone.load_state_dict(
                torch.load(backbone_weights_link, map_location = 'cpu')
            )
