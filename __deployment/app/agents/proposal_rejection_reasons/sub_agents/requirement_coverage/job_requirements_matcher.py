...
from models.schemas import RequirementCoverageSchema
...
class JobRequirementsMatcher(BaseAgent):
    def __init__(
        ...
        **kwargs
        ...
        if "temperature" not in kwargs:
            kwargs = PRR_DEFAULT_MODELS_CFG["job_requirements_matcher"]
    ...
    # -------------------------------- Modeling ----------------------------- #
    def prepare_job_requirements_matcher_ip(self, job_requirements: list, proposal_text: str) -> str:
        mapped_requirements = []
    ...
    def invoke(self, job_requirements: list, proposal_text: str) -> RequirementCoverageSchema:
        formatted_input = self.prepare_job_requirements_matcher_ip(
