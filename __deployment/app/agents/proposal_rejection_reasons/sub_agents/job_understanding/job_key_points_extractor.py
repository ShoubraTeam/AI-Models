...
class JobKeyPointsExtractor(BaseAgent):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if "temperature" not in kwargs:
            kwargs = PRR_DEFAULT_MODELS_CFG["job_key_points_extractor"]
    ...
    # -------------------------- Modeling ---------------------- #
    def prepare_job_key_points_extractor_ip(self, job_desc: str) -> str:
        return f"# Job Description:\n{job_desc}"

    def invoke(self, job_desc: str):
        return super().invoke(self.prepare_job_key_points_extractor_ip(job_desc))
    
    def ainvoke(self, job_desc: str):
        return super().ainvoke(self.prepare_job_key_points_extractor_ip(job_desc))
